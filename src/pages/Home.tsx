...
const achievements = [
  {
    ...
    year: "2021",
    details:
      "Secured first place out of 8 to 10 teams as a company hackathon champion (hacking marathon) for the chatbot innovation. The chatbot improves the user experience and in turn conversion rate.",
  },
  {
...
const handleDownload = () => {
  ...
  link.href = "/SaiSivaTejaBejjipuramResume.pdf";
  link.download = "SaiSivaTejaBejjipuramResume.pdf";
...
const Home = () => {
  return (
    <div className="min-h-screen">
      ...
      <section
        id="experience"
        className="section-padding bg-white dark:bg-zinc-900"
      >
        <div className="container-custom">
      ...
      <section
        id="projects"
        className="section-padding bg-zinc-50 dark:bg-zinc-800"
      >
        <div className="container-custom">
          <h2 className="text-3xl font-bold mb-8 text-primary-700 dark:text-primary-400">
            Projects
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {achievements.map((a) => (
              <div key={a.title} className="card">
                <div className="font-bold text-lg text-zinc-900 dark:text-zinc-100 mb-2">
                  {a.title}{" "}
